...
- npm ui / spartan: `src/npm/packages/ui/src/*.spec.ts`, `src/npm/packages/spartan/src/*.spec.ts`
- npm cli: `src/npm/packages/cli/schematics/spartan-grid/index.spec.cjs`
