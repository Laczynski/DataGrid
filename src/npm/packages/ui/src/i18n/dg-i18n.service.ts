...
import { DG_I18N_CONFIG, DG_TRANSLATE_FN } from "./dg-i18n.tokens";

@Injectable({ providedIn: "root" })
export class DgI18nService {
  private readonly config = inject(DG_I18N_CONFIG);
  private readonly translateFn = inject(DG_TRANSLATE_FN, { optional: true });
