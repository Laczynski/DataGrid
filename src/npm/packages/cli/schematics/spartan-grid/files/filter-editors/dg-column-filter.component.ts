...
import type { GridColumn, GridColumnFilterType, GridSize } from "@laczynski/datagrid-spartan";
import {
  DgI18nService,
...
} from "../grid-shell/dg-helm-utils";
import { resolveDgGridIcon } from "../grid-shell/dg-icon-map";
...
@Component({
  selector: "dg-column-filter",
  standalone: true,
  imports: [FormsModule, ...DG_GRID_HELM_IMPORTS],
  providers: [provideDgGridHelmIcons()],
  changeDetection: ChangeDetectionStrategy.OnPush,
  templateUrl: "./dg-column-filter.component.html",
  styleUrl: "./dg-column-filter.component.scss",
  host: {
    "(click)": "$event.stopPropagation()",
  },
})
export class DgColumnFilterComponent<T = unknown> {
