namespace DataGrid.Abstractions;

/// <summary>
/// Stable machine-readable codes for <see cref="GridValidationException"/>.
/// Keep in sync with <c>@laczynski/datagrid</c> <c>GRID_VALIDATION_CODES</c> (TypeScript).
/// </summary>
...
/// Keep in sync with <c>@laczynski/datagrid</c> <c>GRID_TRANSPORT_ERROR_CODES</c> (TypeScript).
/// </summary>
