...
Transport contracts for [QueryGrid](https://github.com/laczynski/QueryGrid): `GridQuery`, `GridResult`, filter/sort types, DTO attributes, and JSON serialization helpers. Zero dependencies.
